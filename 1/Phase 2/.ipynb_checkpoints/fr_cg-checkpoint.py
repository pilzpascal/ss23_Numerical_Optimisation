...
def fr_cg(
    ...
    while grad_k_norm > eps:
        ...
        beta_k = (grad_k_next.T @ grad_k_next) / (grad_k.T @ grad_k)
...
if __name__ == '__main__':
    import funcs as fc
    'Problems 1-3)'
    print(fr_cg(fc.rosenbrock, fc.rosenbrock_gradient, np.array([1.2, 1.2]), np.array([1., 1.])))
    print(fr_cg(fc.rosenbrock, fc.rosenbrock_gradient, np.array([-1.2, 1.]), np.array([1., 1.])))
    print(fr_cg(fc.rosenbrock, fc.rosenbrock_gradient, np.array([0.2, 0.8]), np.array([1., 1.])))

    'Problems 4-6)'
    print(fr_cg(fc.nl_f, fc.nl_f_grad, np.array([-0.2, 1.2]), np.array([0., 1.])))
    print(fr_cg(fc.nl_f, fc.nl_f_grad, np.array([3.8, 0.1]), np.array([4., 0.])))
    print(fr_cg(fc.nl_f, fc.nl_f_grad, np.array([1.9, 0.6]), np.array([0., 1.])))
